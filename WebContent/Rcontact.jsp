...
try
{
	...
	String qry="SELECT u.u_name,u.u_email FROM user_master u JOIN login l ON (u.u_email = l.l_email) WHERE l.l_id="+id;
								...
								<form action="${pageContext.request.contextPath}/ContactTest"  method="POST" id="contactform">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" id="nm" name="nm" value="<%=name %>"  readonly class="form-control input-lg">
										</div>	
									</div>
									<div class="col-md-12">
										<div class="form-group">
											<label for="email" class="sr-only">Email</label>
											<input type="text" id="email" name="email" value="<%=email %>" readonly class="form-control input-lg">
										</div>	
									</div>
